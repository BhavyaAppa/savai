package com.example.alokozapshopapplication.ui.fragment.productdetailsdata.model
...
data class ProductDetailsResponse(
    ...
    var imageGallery: List<ImageGallery>? = listOf(),
    ...
    var relatedProductList: List<RelatedProduct>? = listOf(),
    ...
    var upsellProductList: List<UpsellProduct>? = listOf()
) {
